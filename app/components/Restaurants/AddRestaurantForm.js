    ...
    const addRestaurant=()=>{
        ...
        // console.log(locationRestaurant);
            ...
            uploadImageStorage().then((response)=>{
                const imagesb=response.reverse();
...
function ImageRestaurant(props){
    ...
    return(
        <View style={styles.viewPhoto}>
            <Image 
                source={
                    imagenRestaurant ? {uri: imagenRestaurant}
...
function Map(props){
    const {isVisibleMap, setIsVisibleMap,
       ...
       (async()=>{
           ...
           if(statusPermissions !== "granted"){
               toastRef.current.show(
                   "Tienes que aceptar los permisos de localizacion para crear restaurante",3000
               );
           }else{
...
function UploadImage(props){
    ...
    const imageSelect= async()=>{
        ...
        if(resultPermissions ==="denied"){
            toastRef.current.show("Es necesario aceptar los permisos de la galeria, si lo has rechazado tienes que ir a ajustes y activarlos manualmente",3000);
        }else{
            ...
            [
                ...
                },
                {
                    ...
                    onPress: ()=>{
                        setImageSelected(
                            filter(
                                imageSelected, (imageUrl)=> imageUrl !== image
                            )
                        );
                    }
                }
